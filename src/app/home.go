...
func Home(app *server.App) Node {
	return Main(
		Div(
			...
			HeroBackground(
				Class("top-0 bottom-0 m-auto skew-y-12 [mask-image:radial-gradient(800px_circle_at_center,white,transparent)] z-0"),
			),

			Div(
				Class("relative z-10 flex flex-col items-center gap-8 max-w-xl mx-auto text-center"),
